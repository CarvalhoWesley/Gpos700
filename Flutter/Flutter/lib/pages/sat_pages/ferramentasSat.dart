...
class _PageFerramentaSatState extends State<PageFerramentaSat> {
  ...
  void ferramentasSat(String funcao) async {
    ...
    if (funcao == "Versao" ||
      ...
      if (funcao == "Versao") {
        WidgetsGertec.dialogoSat(retornoSat?.getResultadoCompleto,
            context: context);
      } else {
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              SizedBox(height: 20),
              WidgetsGertec.buttonStandard("BLOQUEAR SAT",
                  callback: () => ferramentasSat("BloquearSat")),
              WidgetsGertec.buttonStandard("DESBLOQUEAR SAT",
                  callback: () => ferramentasSat("DesbloquearSat")),
              WidgetsGertec.buttonStandard("EXTRAIR LOG",
                  callback: () => ferramentasSat("ExtrairLog")),
              WidgetsGertec.buttonStandard("ATUALIZAR SOFTWARE",
                  callback: () => ferramentasSat("AtualizarSoftware")),
              WidgetsGertec.buttonStandard("VERIFICAR VERSÃO",
                  callback: () => ferramentasSat("Versao")),
            ],
          ),
        ),
      ),
